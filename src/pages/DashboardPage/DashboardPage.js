            ...
            <header>
                <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="/dashboard">Carousel</a>
                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="container">
                                <div class="carousel-caption text-start">
                                    ...
                                    <p><button class="btn btn-lg btn-primary" type="button">Sign up today</button></p>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            ...
                            <div class="container">
                                <div class="carousel-caption">
                                    ...
                                    <p><button class="btn btn-lg btn-primary" type="button">Learn more</button></p>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            ...
                            <div class="container">
                                <div class="carousel-caption text-end">
                                    ...
                                    <p><button class="btn btn-lg btn-primary" type="button">Browse gallery</button></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <p>Some representative placeholder content for the three columns of text below the carousel. This is
                                the first column.</p>
                            <p><button type="button" class="btn btn-secondary">View details &raquo;</button></p>
                        </div>{/* /.col-lg-4 */}
                        <div class="col-lg-4">
                            <svg class="bd-placeholder-img rounded-circle" width="140" height="140"
                                xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140"
                ...
                <footer class="container">
                    <p class="float-end">
                        <button
                            ...
                            style={{ textDecoration: "underline", background: "none", border: "none", color: "#0d6efd", cursor: "pointer" }}
                        >
                            Back to top
                        </button>
                    </p>
                    <p>&copy; 2017–2021 Company, Inc. &middot; <a href="/privacy">Privacy</a> &middot; <a href="/terms">Terms</a></p>
                </footer>
            </main>
        </>
    );
